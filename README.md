...
## ReThink — Codex Instructions

### Stack Rules (NON-NEGOTIABLE)
- Flutter + Riverpod v2 (Notifier pattern ONLY)
- Hive with MANUAL TypeAdapters
- NO build_runner, NO code generation, NO .g.dart files
- NO @HiveType / @HiveField / extends HiveObject
- NO final fields in Hive model classes
- typeId map: topics=0, habits=1, vault=2, attachments=4

### SRS Logic
- Intervals: [1, 5, 14, 28] days
- Grades: AGAIN(0), HARD(1), GOOD(2), EASY(3)
- completedCycles must be clamped to totalCycles max

### Style
- AMOLED dark: scaffold = #0D0D0F
- Teal accent: #00C9A7
- GlassCard with BackdropFilter for cards
